...
Fecha: 2026-07-13 12:51:09
Base SQLite: `C:\Users\Administrador\Downloads\MIGRACION CONTROL TAXI\MIGRACION CONTROL TAXI\DatosLocal\ControlTaxi.db`
...
|---|---|---|---|
| Ventas | mkt__dbo__mov_operacion: 9,843<br>mkt__dbo__operacion: 24,499<br>compuadmo__dbo__Productos: 26,896<br>joyeria__dbo__Productos: 7,175 | LocalProductos: 33,979<br>LocalVentas: 4,499<br>LocalVentaLineas: 12,910 | Implementado; pendiente comparar resultados Web vs Desktop |
...
| Comisiones | mkt__dbo__mov_operacion: 9,843<br>mkt__dbo__transporte: 23<br>mkt__dbo__dejadas: 39,433<br>mkt__dbo__RelacionTicketTaxista: 56 | LocalComisiones: 4,499 | Implementado; pendiente comparar resultados Web vs Desktop |
...
| Reportes | mkt__dbo__mov_operacion: 9,843<br>mkt__dbo__AppMovilRegistro: 1,172<br>mkt__dbo__dejadas: 39,433 | LocalVentas: 4,499<br>LocalPagos: 5,414<br>LocalComisiones: 4,499<br>LocalCortes: 684 | Implementado; pendiente comparar resultados Web vs Desktop |
...
| Usuarios y permisos | ControlTaxis__dbo__Usuarios: 3<br>ControlTaxis__dbo__UsuarioPermisos: 43 | DesktopUsers: 3<br>DesktopPermissions: 43 | Implementado; pendiente comparar resultados Web vs Desktop |
| AuditorÃ­a | mkt__dbo__AuditoriaMovimiento: 4,249 | LocalAuditoria: 4,249 | Implementado; pendiente comparar resultados Web vs Desktop |
| Gafetes | mkt__dbo__gafete: 283,474<br>mkt__dbo__AppMovilRegistroGafetes: 946 | LocalGafetes: 556 | Implementado; pendiente comparar resultados Web vs Desktop |
...
| Gafetes: distintivos vigentes | gafetes distintos origen: 556; gafetes Desktop: 556 | Validado con datos reales importados |
| Auditoria: registros | origen: 4,249; Desktop: 4,249 | Validado con datos reales importados |
| Usuarios/permisos | usuarios origen/Desktop: 3/3; permisos origen/Desktop: 43/43 | Validado con datos reales importados |
