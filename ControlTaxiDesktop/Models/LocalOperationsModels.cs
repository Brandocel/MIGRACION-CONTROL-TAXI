...
public sealed record LocalBadge(long Id, string Number, string Status, long? DriverId, string? AssignedAt, string? ReturnedAt, string Staff = "", string OperationFolio = "", string Unit = "", string Phone = "", string Nationality = "", string LocalFolio = "")
{
...
public sealed record LocalScannedBadgeItem(string Number, string Staff, string? OperationFolio, string Status, string Unit = "", string Phone = "", string LocalFolio = "");
