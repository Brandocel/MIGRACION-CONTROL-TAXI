...
{
    public object Convert(object? value, Type targetType, object? parameter, CultureInfo culture) =>
        IsDone(value) ? new SolidColorBrush(Color.FromRgb(0xEA, 0xF8, 0xF2)) : new SolidColorBrush(Color.FromRgb(0xFB, 0xF3, 0xE4));
...
{
    public object Convert(object? value, Type targetType, object? parameter, CultureInfo culture) =>
        StatusBackgroundConverter.IsDone(value) ? new SolidColorBrush(Color.FromRgb(0x0F, 0x6F, 0x58)) : new SolidColorBrush(Color.FromRgb(0x9A, 0x6F, 0x13));
...
{
    public object Convert(object? value, Type targetType, object? parameter, CultureInfo culture) =>
        StatusBackgroundConverter.IsDone(value) ? new SolidColorBrush(Color.FromRgb(0xBF, 0xE7, 0xD2)) : new SolidColorBrush(Color.FromRgb(0xEC, 0xD8, 0xA7));
